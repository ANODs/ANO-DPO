...
export default function FAQSection() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Да, по окончании обучения выдается удостоверение о повышении квалификации установленного образца или сертификат о прохождении programs.",
    },
  ]
  ...
  return (
    ...
    >
      <div className="container mx-auto px-0 !px-0">
        <motion.h2
