...
export default function ContactSection() {
  return (
    <motion.section
      ...
      viewport={{ once: true }}
      className="py-8 lg:py-16 mx-4 lg:mx-0 rounded-lg lg:rounded-none bg-gradient-to-r from-blue-600 to-purple-600"
    >
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-12 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="lg:col-span-2 space-y-4 lg:space-y-6 text-white order-1 lg:order-2"
          >
            ...
            <Button className="w-full lg:w-auto h-11 lg:h-auto bg-white text-blue-600 hover:bg-gray-100">
              Оставить заявку
            </Button>
          </motion.div>
        </div>
